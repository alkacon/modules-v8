...
package com.alkacon.bootstrap.search.client.widgets.datepicker;
...
public class CmsDatePicker extends Composite {
    ...
    protected CmsSearchController m_controller;
     ...
     */
    public CmsDatePicker(CmsSearchController controller, String label, boolean startdate) {
