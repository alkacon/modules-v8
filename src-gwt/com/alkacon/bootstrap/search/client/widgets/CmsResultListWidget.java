...
public class CmsResultListWidget extends A_CmsSearchWidget {
    ...
    private class CmsEntry extends HTMLPanel implements ClickHandler, HasClickHandlers {
        ...
        public CmsEntry(String title, String link, String date, String suffix, String excerpt) {
            ...
            Image img = new Image();
            img.setResource(I_CmsSearchLayoutBundle.INSTANCE.doc());
            if (suffix.equals("doc") || suffix.equals("docx")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.doc());
            } else if (suffix.equals("gif")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.gif());
            } else if (suffix.equals("html") || suffix.equals("htm")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.html());
            } else if (suffix.equals("jpg") || suffix.equals("jpeg")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.jpg());
            } else if (suffix.equals("pdf")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.pdf());
            } else if (suffix.equals("ppt") || suffix.equals("pptx")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.ppt());
            } else if (suffix.equals("xml") || suffix.equals("xsd")) {
                img.setResource(I_CmsSearchLayoutBundle.INSTANCE.xml());
            }
    ...
    public void update(CmsSearchDocumentList result) {
        ...
        if (result.hasDocuments()) {
            ...
            for (CmsSearchDocument oneResult : result.getDocuments()) {
