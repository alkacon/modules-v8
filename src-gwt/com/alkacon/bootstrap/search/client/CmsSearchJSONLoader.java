 ...
 */
public class CmsSearchJSONLoader {
    ...
    public void load(String jsonUrl, I_CmsSearchCallback callback) {
        ...
        // important: the json.wrf parameter        
    ...
    private native void publishCallbackMethod(String callback) /*-{
        ...
        $wnd[callback] = function(obj) {
            ptr.@com.alkacon.bootstrap.search.client.CmsSearchJSONLoader::loadremotedata(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(callback, obj);
        };
    }-*/;
