 ...
 */
public class CmsSearchDocumentList implements IsSerializable {
    ...
    private List<CmsSearchDocument> m_documents;

    /** Map of facet lists. */
    private Map<String, List<CmsSearchFacet>> m_facets;
     ...
     * Constructor.<p>
     */
    public CmsSearchDocumentList() {

        m_documents = new ArrayList<CmsSearchDocument>();
        m_autocompletion = new ArrayList<String>();
        m_facets = new HashMap<String, List<CmsSearchFacet>>();
        m_hits = 0;
    }
     ...
     */
    public void addDocument(CmsSearchDocument searchResult) {
     ...
     */
    public List<CmsSearchDocument> getDocuments() {

        return m_documents;
    }

    /**
     * Gets a list of CmsSearchFacet objects.<p>
     * 
     * @param name the name of the facet
     * @return a list of CmsSearchFacet objects or null
     */
    public List<CmsSearchFacet> getFacet(String name) {

        List<CmsSearchFacet> facet = m_facets.get(name);
        return facet;
    }
     ...
     */
    public void setDocuments(List<CmsSearchDocument> searchResults) {
