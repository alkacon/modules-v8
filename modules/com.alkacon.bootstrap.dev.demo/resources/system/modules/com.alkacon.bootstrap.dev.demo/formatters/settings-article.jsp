...
<div class="margin-bottom-30">
	...
	<div>
<p><pre><b>Text field</b> "Text" = <cms:elementsetting name="text" />
<b>Check box</b> "Show Image" = <cms:elementsetting name="showimage" default="false" />
<b>Date picker</b> "Date" = <cms:elementsetting name="date" />
<b>Radio buttons</b> "Date Format" = <cms:elementsetting name="format" /></pre></p>
	</div>
</div>
</cms:formatter>