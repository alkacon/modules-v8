...
<cms:bundle basename="com.alkacon.unify.schemas.imagegalleryshow">
...
<div class="gallery-page">
	...
	<c:choose>
		<c:when test="${cms.element.inMemoryOnly}">
			<div class="row"><div class="alert"><fmt:message key="unify.imagegalleryshow.message.new" /></div></div>
		</c:when>
		<c:when test="${cms.edited}">
			<div class="row"><div class="alert"><fmt:message key="unify.imagegalleryshow.message.edit" /></div></div>
		    ${cms.enableReload}
		</c:when>
		<c:otherwise>
