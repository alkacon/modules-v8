...
<cms:bundle basename="com.alkacon.unify.schemas.slider">
...
<c:choose>
	<c:when test="${cms.element.inMemoryOnly}">
		<c:if test="${empty cms.element.parent}"><div class="row"></c:if><div class="alert"><fmt:message key="unify.slider.message.new" /></div><c:if test="${empty cms.element.parent}"></div></c:if>
	</c:when>
	<c:when test="${cms.edited}">
		<c:if test="${empty cms.element.parent}"><div class="row"></c:if><div class="alert"><fmt:message key="unify.slider.message.edit" /></div><c:if test="${empty cms.element.parent}"></div></c:if>
		${cms.enableReload}
	</c:when>
	<c:otherwise>
