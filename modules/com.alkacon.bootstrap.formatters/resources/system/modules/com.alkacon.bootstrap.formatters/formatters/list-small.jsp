          ...
          <c:set var="currPage" value="1" />
                ...
                <div id="list_small_pages">
        					<div id="list_small_page_1">
        						<cms:include file="%(link.weak:/system/modules/com.alkacon.bootstrap.formatters/elements/list-small-singlepage.jsp:1e5fced7-5436-11e4-9866-005056b61161)">
            ...
            function loadSmallListPage(page) {
              ...
              if (lastSmallPage != currentSmallPage) {
            		if ($('#list_small_page_' + page).length == 0 ) {
            			...
            			$.post("<cms:link>%(link.weak:/system/modules/com.alkacon.bootstrap.formatters/elements/list-small-singlepage.jsp:1e5fced7-5436-11e4-9866-005056b61161)</cms:link>", { 
