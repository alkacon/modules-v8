$(function() {
    ...
    function updateValues() {
        ...
        result["Paragraph[1]/Headline[1]"] = $(
                formIdHash + " input[name='headline']").val();
        result["Paragraph[1]/Text[1]"] = $(
                formIdHash + " textarea[name='text']").val();
        if ($(formIdHash + " input[name='imagefile']").val() !== '') {
            result["Paragraph[1]/Image[1]/Title[1]"] = $(
                    formIdHash + " input[name='imagetitle']").val();
            result["Paragraph[1]/Image[1]/Description[1]"] = $(
                    formIdHash + " input[name='imagedescription']").val();
        }
        ...
        if (webpageurl === '' && webpagenice === '') {
            ...
            result["Paragraph[1]/Link[1]/URI[1]"] = $(
                    formIdHash + " input[name='webpageurl']").val();
            result["Paragraph[1]/Link[1]/Text[1]"] = $(
                    formIdHash + " input[name='webpagenice']").val();
        }
    ...
    function fillForm() {
        if (content != null) {
            $(formIdHash + " input[name='headline']").val(
                    content["Paragraph[1]/Headline[1]"]);
            $(formIdHash + " textarea[name='text']").val(
                    content["Paragraph[1]/Text[1]"]);
            $(formIdHash + " input[name='imagetitle']").val(
                    content["Paragraph[1]/Image[1]/Title[1]"]);
            $(formIdHash + " input[name='imagedescription']").val(
                    content["Paragraph[1]/Image[1]/Description[1]"]);
            $(formIdHash + " input[name='webpageurl']").val(
                    content["Paragraph[1]/Link[1]/URI[1]"]);
            $(formIdHash + " input[name='webpagenice']").val(
                    content["Paragraph[1]/Link[1]/Text[1]"]);
            $(formIdHash + " input[name='author']").val(content["Author[1]"]);
            $(formIdHash + " input[name='authormail']").val(
                    content["AuthorMail[1]"]);
        }
    }
    function saveContent(uploadResult) {
        ...
        session.saveContent(newValues, function(s) {
            session.destroy();
