...
/**
 * An interface that holds some constants for the dialogs.<p>
 * 
 * @since 8.0.0
 */
public interface I_CmsDialogConstants extends IsSerializable {
    ...
    /** Dialog JSP URI. */
    String DIALOG_JSP_URI = "/system/modules/com.alkacon.opencms.v8.dialogs/dialog.jsp";
}
